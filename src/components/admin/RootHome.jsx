        ...
        <Grid item xs={12} sm={12} md={6}>
          ...
          >
              ...
              {/* <div style={{ flexDirection:'row' , flex:1 , justifyContent:'flex-start'}}> */}
                <h1 className="text-base text-[#344054] font-normal"  >   Users Registeration</h1>
            </div>  
      <Table columns={columns} dataSource={data}  style={{ marginTop: 20 }}  pagination={{ position: ["bottomCenter"] }} />;
        ...
        <Grid item xs={12} sm={12} md={6}>
          ...
          >
            ...
            <div className="flex flex-row justify-start align-bottom items-center">
              {/* <div style={{ flexDirection:'row' , flex:1 , justifyContent:'flex-start'}}> */}
                <h1 className="text-base text-[#344054] font-normal"  >  Campus Registeration</h1>
            </div>  
      <Table columns={columns1} dataSource={data1}  style={{ marginTop: 20 }}  pagination={{ position: ["bottomCenter"] }}/>;
            {/* <div className="flex flex-row justify-start align-bottom items-center">
