...
const AddCourse = () => {
  ...
  return (
    <div className="mb-8 flex flex-col gap-6 bg-white p-5 rounded-md shadow-md">
        ...
        <Row gutter={16}>
          <Col span={12}>
            ...
            <Form.Item
              ...
              rules={[{ required: true }]}
            >
              <Input type="number" className="p-2 shadow-sm" />
            </Form.Item>
            <Form.Item
              name="contacthour"
              label="Contact Hour"
      ...
      {/* <h2>Course Table</h2> */}
      <div className="mb-8 flex flex-col gap-6 bg-white p-5 rounded-md shadow-md">
        <p className="!font-jakarta text-left text-[#4567a7] text-[18px] font-bold align-middle my-6">
          Course Table{" "}
        </p>
        <Table
